...
class Train(models.Model):
	...
	from_station = models.ForeignKey(Station, related_name = "start_station_train", blank = True, null = True, on_delete = models.CASCADE)
	to_station = models.ForeignKey(Station, related_name = "end_station_train", blank = True, null = True, on_delete = models.CASCADE)
